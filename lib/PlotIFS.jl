...
#> [frontmatter]
#> title = "Plotting IFS attractors"
#> date = "2025-05-15"
#> tags = ["IFS", "self-affine"]
...
# ╔═╡ 6f274801-80c8-4588-8c1c-7af831559d26
md"""
`` \lambda = `` $(@bind λ Slider(1/2 : 0.001 : 1; default= 0.6, show_value=true))
"""
...
begin
	...
	f_Weier = Function[]
	for i in 1:b
		push!(f_Weier, x ->  [1/b * x[1] + (i-1)/b, lambda * x[2] + ψ(x[1])])
	end

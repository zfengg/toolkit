% myfinalchanges.tex @ https://github.com/zfengg/toolkit/tree/master/tex/myfinalchanges
%
% 	A simple tex template based on amsmath-userguide for daily tasks.
%
% Zhou Feng @ 20/07/2025
% ---------------------------------------------------------------------------- %
%                                   preamble                                   %
% ---------------------------------------------------------------------------- %
...
% --------------------------------- titlepage -------------------------------- %
\title{Changes to the accepted version}
...
In the final version of the manuscript, I have made the following changes to the accepted version.

\begin{enumerate}
	\setlength{\itemsep}{0.8em}

	\item Removed the red highlights, which were previously included to assist the referee in comparing the revised manuscript with the original submission.
	
	\item Improved the clarity and consistency of several expressions and notations, including correcting typos and grammatical issues, and refining in-text formatting—e.g., \ldots
...
%\bibliography{response}\label{sec:ref}

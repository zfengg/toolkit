% myresponse.tex @ https://github.com/zfengg/toolkit/tree/master/tex/myresponse
%
...
% --------------------------------- titlepage -------------------------------- %
\title{Response to the referee's report}
...
\begin{document}
	...
	I thank the referee for their careful reading of my manuscript and for their detailed and valuable suggestions. I have carefully addressed all of the referee’s comments. Below, I provide my point-by-point responses, following the order of the referee’s report. The corresponding changes are highlighted in red in the revised manuscript.
...
\bibliography{myresponse}\label{sec:ref}

%	Filename: myarticle.tex
%   Version: 1.0
%	Date: 08/11/2020
%	e-mail: zfeng@math.cuhk.edu.hk 

%   An all-in-one (most features from amsmath userguide) article template for daily tasks. 
...
\usepackage{aliascnt} % for auto reference of difference environments with the same counter
\usepackage[bookmarks=true,colorlinks,linkcolor=blue,pagebackref,citecolor=blue,urlcolor=black]{hyperref}
...
%---cross reference---%
%\usepackage[nameinlink]{cleveref} % change the reference style, cleveref must load the last
...
\newcommand{\ndiml}[1][n]{$#1$\nobreakdash-dim}
\newcommand{\padic}{$p$\nobreakdash-adic} % for p-adic typing
...
\newcommand{\measureMu}[1][\lambda]{\mu_{#1}}
\newcommand{\dimmeasureMu}[1][\lambda]{\dim\mu_{#1}}

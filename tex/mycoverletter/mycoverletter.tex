% mycoverletter.tex @ https://github.com/zfengg/toolkit/tree/master/tex/mycoverletter
%
% 	A simple tex template for daily task.
%
...
I would like to submit my manuscript entitled ``Title of the manuscript'' for your consideration for publication in \textit{Title of the journal}.
...
Email: \texttt{\href{mailto:zfeng.math@outlook.com}{zfeng.math@outlook.com}}
...
%\bibliography{coverletter}\label{sec:ref}

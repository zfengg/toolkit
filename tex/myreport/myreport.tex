% myreport.tex @ https://github.com/zfengg/toolkit/tree/master/tex/myreport
%
...
% --------------------------------- titlepage -------------------------------- %
\title{Report: Title of the manuscript}
...
\begin{document}
	...
	\begin{itemize}
		...
		\item Summary of main results.
		
		\item Major contribution.
		
		\item Strong recommendation.
	...
	Although I find the proofs to be mathematically correct, I believe that some minor points could benefit from further elaboration and explanation. These points, along with a few typographical errors, are listed below.
...
\bibliography{myreport}\label{sec:ref}
